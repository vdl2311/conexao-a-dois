      ...
      <div className="max-w-[820px] mx-auto">
        ...
        <Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-12">
            <div className="bg-white/5 border border-brand-gold/25 rounded-[16px] py-7 px-6 text-center transition-colors duration-200 hover:bg-brand-gold/10">
              <p className="text-[11px] tracking-[2px] text-brand-gold font-bold uppercase mb-2.5">
                Semana 1 · Dias 1–7
              </p>
              <h3 className="text-[22px] text-white mb-2">Comunicação</h3>
              ...
              <div className="flex gap-1.5 justify-center mt-4 flex-wrap">
                {[1, 2, 3, 4, 5, 6, 7].map((day) => (
                  <span key={day} className="w-7 h-7 rounded-full bg-brand-gold/15 border border-brand-gold/30 text-[10px] font-bold text-brand-gold flex items-center justify-center">
                    {day}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-white/5 border border-brand-gold/25 rounded-[16px] py-7 px-6 text-center transition-colors duration-200 hover:bg-brand-gold/10">
              ...
              <h3 className="text-[22px] text-white mb-2">Finanças</h3>
              <p className="text-[13px] text-white/55 leading-[1.6]">
            ...
            <div className="bg-white/5 border border-brand-gold/25 rounded-[16px] py-7 px-6 text-center transition-colors duration-200 hover:bg-brand-gold/10">
              ...
              <h3 className="text-[22px] text-white mb-2">Intimidade</h3>
              <p className="text-[13px] text-white/55 leading-[1.6]">
