      ...
      <div className="max-w-[820px] mx-auto">
        ...
        <Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 mt-12">
            <div className="bg-brand-light rounded-[16px] p-8 border border-brand-gold/20 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(26,39,68,0.1)]">
              <div className="w-14 h-14 bg-gradient-to-br from-brand-gold to-brand-gold2 rounded-xl flex items-center justify-center text-[26px] mb-5">
                💬
              </div>
              <h3 className="text-[20px] mb-3 text-brand-navy">Prompts de diálogo estruturado</h3>
              <p className="text-[16px] leading-[1.7] text-brand-gray">
            ...
            <div className="bg-brand-light rounded-[16px] p-8 border border-brand-gold/20 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(26,39,68,0.1)]">
              ...
              <h3 className="text-[20px] mb-3 text-brand-navy">5 minutos por dia</h3>
              <p className="text-[16px] leading-[1.7] text-brand-gray">
            ...
            <div className="bg-brand-light rounded-[16px] p-8 border border-brand-gold/20 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(26,39,68,0.1)]">
              ...
              <h3 className="text-[20px] mb-3 text-brand-navy">Finanças sem tabu</h3>
              <p className="text-[16px] leading-[1.7] text-brand-gray">
            ...
            <div className="bg-brand-light rounded-[16px] p-8 border border-brand-gold/20 transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(26,39,68,0.1)]">
              ...
              <h3 className="text-[20px] mb-3 text-brand-navy">Intimidade e conexão</h3>
              <p className="text-[16px] leading-[1.7] text-brand-gray">
