        ...
        <Reveal>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 mb-16">
            <div className="border-l-4 border-brand-gold pl-6 py-2">
              <p className="font-serif italic text-[22px] md:text-[24px] text-brand-navy leading-snug">
        ...
        <Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10">
            <div className="bg-white rounded-[14px] p-6 shadow-[0_4px_18px_rgba(26,39,68,0.07)] relative before:content-['\22'] before:font-serif before:text-[64px] before:text-brand-gold before:opacity-30 before:absolute before:top-2 before:left-4 before:leading-none">
              <p className="text-[14px] leading-[1.8] text-brand-navy mt-5 italic">
              ...
              <p className="mt-4 text-[13px] font-bold text-brand-navy">
                Marcelo e Camila <span className="text-[12px] text-brand-gray font-normal">— casados há 8 anos</span>
              </p>
              <div className="text-brand-gold text-[14px] mt-2.5">★★★★★</div>
            </div>
            ...
            <div className="bg-white rounded-[14px] p-6 shadow-[0_4px_18px_rgba(26,39,68,0.07)] relative before:content-['\22'] before:font-serif before:text-[64px] before:text-brand-gold before:opacity-30 before:absolute before:top-2 before:left-4 before:leading-none">
              ...
              <p className="mt-4 text-[13px] font-bold text-brand-navy">
                Renata e Felipe <span className="text-[12px] text-brand-gray font-normal">— casados há 5 anos</span>
              </p>
              <div className="text-brand-gold text-[14px] mt-2.5">★★★★★</div>
            </div>
            ...
            <div className="bg-white rounded-[14px] p-6 shadow-[0_4px_18px_rgba(26,39,68,0.07)] relative before:content-['\22'] before:font-serif before:text-[64px] before:text-brand-gold before:opacity-30 before:absolute before:top-2 before:left-4 before:leading-none">
              ...
              <p className="mt-4 text-[13px] font-bold text-brand-navy">
                Thiago e Priscila <span className="text-[12px] text-brand-gray font-normal">— casados há 12 anos</span>
              </p>
              <div className="text-brand-gold text-[14px] mt-2.5">★★★★★</div>
            </div>
          </div>
