  ...
  return (
    <section className="bg-brand-navy min-h-screen flex flex-col items-center justify-center py-[60px] px-5 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-brand-gold/15 border border-brand-gold text-brand-gold text-[11px] font-bold tracking-[3px] uppercase py-[7px] px-5 rounded-[30px] mb-7"
      >
      ...
      <motion.h1 
        ...
        className="text-white text-[clamp(38px,7vw,72px)] leading-[1.1] text-center max-w-[820px]"
      >
      ...
      <motion.p 
        ...
        className="text-white/75 text-[clamp(15px,2.5vw,18px)] text-center max-w-[600px] mt-5 leading-[1.7]"
      >
      ...
      >
        <div className="text-center">
          <strong className="block font-serif text-[40px] text-brand-gold leading-none">21</strong>
          <span className="text-[12px] text-white/60 tracking-[1px] uppercase mt-1 block">dias de desafio</span>
        </div>
        <div className="text-center">
          <strong className="block font-serif text-[40px] text-brand-gold leading-none">3</strong>
          <span className="text-[12px] text-white/60 tracking-[1px] uppercase mt-1 block">temas essenciais</span>
        </div>
        <div className="text-center">
          <strong className="block font-serif text-[40px] text-brand-gold leading-none">5</strong>
          <span className="text-[12px] text-white/60 tracking-[1px] uppercase mt-1 block">minutos por dia</span>
        </div>
      </motion.div>
      ...
      <motion.div 
        ...
        className="mt-11 flex flex-col items-center gap-3 w-full"
      >
        ...
        <div className="text-[14px] leading-[1.6] text-white/70 text-center max-w-[500px] mt-2">
