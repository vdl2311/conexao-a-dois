        ...
        <Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
            <div className="bg-[#EDFAF1] border border-[#A8DDB8] rounded-[14px] p-7">
              <h4 className="text-[#1A6B38] mb-4 text-[18px] font-serif">✓ Este guia é para você se:</h4>
              <ul className="pl-0">
            ...
            <div className="bg-[#FDF0EF] border border-[#F5B8B3] rounded-[14px] p-7">
              <h4 className="text-[#9B2335] mb-4 text-[18px] font-serif">✗ Este guia não é para você se:</h4>
              <ul className="pl-0">
